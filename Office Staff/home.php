...
<?php	
	...
	echo '<a href="index.php?id='.$ida.'"><input type="button" class="btn btn-primary" value="Add New Office Staff"></a><br><br>';
	
	echo '<table  class="table table-striped table-bordered table-hover"  id="dataTables-example">
	<thead><tr><th></th><th>Name</th><th>NIC Number</th><th>Address</th><th>First Appoinment Date</th><th>Post</th><th></th></tr></thead><tbody>';	
	$x=1;
	while($viewarr = mysqli_fetch_assoc($view))
	{
		echo '<tr><td>'.$x.'</td><td>'.$viewarr["Name"].'</td><td>'.$viewarr["NIC_number"].'</td><td>'.$viewarr["Address"].'</td>
		<td>'.$viewarr["First_appoinment_date"].'</td><td>'.$viewarr["Post"].'</td><td>';     
